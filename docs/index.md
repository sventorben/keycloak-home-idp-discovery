...
![Keycloak Dependency Version](https://img.shields.io/badge/Keycloak-26.6.2-blue)
...
1. If the `forwardToLinkedIdp` config option is enabled
    ...
    4. If no domain could be determined and `forwardNoEmail` is enabled: use the first linked identity provider
